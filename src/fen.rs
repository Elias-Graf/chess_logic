...
impl Fen for PieceInstance {
    fn get_fen(&self) -> String {
        match (&self.player, &self.piece) {
            ...
            // the piece.
            (Player::You, Piece::Bishop) => "B",
            (Player::You, Piece::King) => "K",
            (Player::You, Piece::Knight) => "N",
            (Player::You, Piece::Pawn) => "P",
            (Player::You, Piece::Queen) => "Q",
            (Player::You, Piece::Rook) => "R",
            (Player::Opponent, Piece::Bishop) => "b",
            (Player::Opponent, Piece::King) => "k",
            (Player::Opponent, Piece::Knight) => "n",
            (Player::Opponent, Piece::Pawn) => "p",
            (Player::Opponent, Piece::Queen) => "q",
            (Player::Opponent, Piece::Rook) => "r",
        }
        .to_owned()
    }
